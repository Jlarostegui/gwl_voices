...
namespace gwl_voices.API.Controllers
{
    ...
    public class WorkingGroupsController : Controller
    {
        ...
        //No funciona correctamente Revisr query
        [HttpGet]
        [Route("all")]
        public IActionResult GetAllWorkingGroups()
        {
            List<WorkingGroupResponse> workingGroups = _workingGroupService.GetAllWorkingGroups();
